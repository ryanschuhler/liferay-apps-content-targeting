...
package com.liferay.content.targeting.rule.country;
...
public class CountryRule extends BaseRule {
	...
	public boolean evaluate(
		...
		String userCountry = getUserCountry(anonymousUser);

		String country = ruleInstance.getTypeSettings();

		if (Validator.equals(userCountry, country)) {
			return true;
		}
	...
	public String getUserCountry(AnonymousUser anonymousUser) {
	...
	protected void populateContext(
		...
		if (!values.isEmpty()) {
			...
			country = ruleInstance.getTypeSettings();
		}
